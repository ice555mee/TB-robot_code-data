...
ax1.text(0.25*8,0.97,"a",fontsize=20,weight='bold',fontname='Times New Roman')
ax2.text(0.25*8,0.9,"c",fontsize=20,weight='bold',fontname='Times New Roman')
ax3.text(0.25*4,0.97,"b",fontsize=20,weight='bold',fontname='Times New Roman')
ax4.text(0.25*4,0.9,"d",fontsize=20,weight='bold',fontname='Times New Roman')
