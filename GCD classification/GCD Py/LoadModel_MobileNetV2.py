...
K =["MobileNetV2_GCD","MobileNetV2_CV"]
m=1
for model in K :
    m+=1
    Model =model
...
ax1.text(1.5,0.97,"a",fontsize=20,weight='bold',fontname='Times New Roman')
ax2.text(1.5,0.9,"c",fontsize=20,weight='bold',fontname='Times New Roman')
ax3.text(1.5,0.97,"b",fontsize=20,weight='bold',fontname='Times New Roman')
ax4.text(1.5,0.9,"d",fontsize=20,weight='bold',fontname='Times New Roman')
