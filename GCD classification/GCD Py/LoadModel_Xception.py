...
ax1.text(1,0.97,"a",fontsize=20,weight='bold',fontname='Times New Roman')
ax2.text(1,0.92,"c",fontsize=20,weight='bold',fontname='Times New Roman')
ax3.text(1,0.97,"b",fontsize=20,weight='bold',fontname='Times New Roman')
ax4.text(1,0.92,"d",fontsize=20,weight='bold',fontname='Times New Roman')
